...
void _productEntitySerialize(
  ...
  writer.writeLong(offsets[6], object.quantityInCart);
...
ProductEntity _productEntityDeserialize(
  ...
  final object = ProductEntity(
    ...
    isFavourite: reader.readBoolOrNull(offsets[4]),
    price: reader.readDoubleOrNull(offsets[5]),
    quantityInCart: reader.readLongOrNull(offsets[6]),
...
extension ProductEntityQueryFilter
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterFilterCondition>
      quantityInCartEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'quantityInCart',
        value: value,
...
extension ProductEntityQuerySortBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByIsFavourite() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQuerySortThenBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByIsFavourite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavourite', Sort.asc);
    });
  }
...
extension ProductEntityQueryProperty
  ...
  QueryBuilder<ProductEntity, bool?, QQueryOperations> isFavouriteProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, int?, QQueryOperations> quantityInCartProperty() {
    return QueryBuilder.apply(this, (query) {
